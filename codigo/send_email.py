...
#
filename_formato_planilla = "C:\\roda\\codiner-portal\\output\\Formato Planilla.xlsx"
#
...
print('------------------------------------')
#
asunto = f'[bot] Reporte de Ejecución - Procesamiento Facturas/Boletas - Codiner - ' + str(datetime.datetime.today().strftime('%d-%m-%Y'))
#
# Lista de destinatarios - Leer el archivo de Excel
destination_1 = pd.read_excel('C:\\roda\\codiner-portal\\config\\destinatarios.xlsx')
